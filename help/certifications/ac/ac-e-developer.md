...
# Jornada de certificação para o especialista em desenvolvedores [!DNL Adobe Commerce]

{{intro}}

>[!NOTE]
>
>**Novos recursos de estudo disponíveis:** O [Guia de Preparação do Exame](https://app.rockinfo.com/courses/141) fornece um caminho personalizado por meio do processo de preparação do exame de certificação, incluindo os materiais necessários para obter essa certificação. _Se for solicitado a fazer logon no Guia de Preparação do Exame, use sua Adobe ID._
...
Você deve ter pelo menos 1-3 anos de experiência com o desenvolvimento do Adobe [!DNL Commerce] e está familiarizado com as seguintes tecnologias e ambientes:
...
* Identificar recurso de segurança do Adobe [!DNL Commerce] (CSP, escape, chaves de formulário, limpeza, reCAPTCHA, validação de entrada)
...
**Seção 2: Trabalhando com Bancos de Dados e EAV (10%)**
...
**Seção 4: Personalizando o Catálogo (6%)**
...
* Demonstrar conhecimento do fluxo de trabalho de arquitetura/ambiente do Adobe [!DNL Commerce]
* Demonstrar um conhecimento prático dos arquivos, permissões e estrutura do projeto na nuvem
* Demonstrar a capacidade de configurar lojas baseadas em vários domínios na Nuvem do Adobe [!DNL Commerce] (combinação de sites de vários domínios de trabalho de desenvolvimento e suporte)
...
**Seção 8: instalar/configurar o Adobe [!DNL Commerce] Cloud (10%)**

* Descreva como instalar/configurar o Adobe [!DNL Commerce] Cloud
...
* Demonstrar compreensão do gerenciamento de ambiente usando CLI (recursos exclusivos de CLI: ativar emails, ambientes de rebase, instantâneo, despejo de banco de dados, configuração de ambiente local)
...
[Responder ao questionário de preparação online](https://scorpion.caveon.com/launchpad/ad-q-e716-readiness-questionnaire-for-adobe-commerce-developer-expert/ad-q-e716-readiness-questionnaire-for-adobe-commerce-developer-expert){target="_blank"}
...
[Exibir Guia de Preparação do Exame](https://app.rockinfo.com/courses/141)
