...
* Adobe Analytics Architect Principal
...
As avaliações do curso são gratuitas. Não há necessidade de programá-los, e eles não são monitorados. Se você tiver várias certificações de nível Principal e de especialista da Adobe Analytics, precisará apenas concluir os requisitos abaixo e todas as certificações da Adobe Analytics nesse nível serão renovadas.
