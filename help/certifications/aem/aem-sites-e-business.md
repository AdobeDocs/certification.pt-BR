...
# Jornada de certificação para Adobe [!DNL Experience Manager Sites] Especialista em profissionais
...
* Experimente os recursos e as AEM necessárias para envolver os desenvolvedores a encontrar soluções de negócios
* A capacidade de usar AEM produtos para gerenciar conteúdo para impulsionar experiências digitais
* Uma compreensão de quais módulos estão presentes
* Um insight mais profundo em módulos como [!DNL Sites], [!DNL Assets]e [!DNL Forms]
...
* Controle de versão
* Hub de personalização e contexto
* Editor SPA
* Marcação com tags
* Uso do navegador
* Compreensão geral da Web
* Conceitos responsivos de design da Web
...
Nível: Pontuação de aprovação de especialistas (de 1 a 3 anos de experiência): 32/50 Tempo: Delivery de 100 minutos: Idiomas disponíveis do centro de teste ou de reprodução on-line (requer acesso à câmera): Custo inglês e japonês: ID do exame de $225 (global) / $150 (Índia): AD0-E121
...
* Listar recursos e recursos AEM relevantes
* Recomendar como aproveitar AEM recursos para atender às necessidades dos negócios
* Aplique os conceitos de procedimento necessários para realizar o treinamento de editores de conteúdo

Seção 2: Arquitetura (24%)

* Recomendar uma arquitetura de informações para aproveitar AEM recursos padrão para atender às necessidades dos negócios usando o ambiente no local ou Adobe hosted (Cloud)
* Descreva como o AEM se integra a serviços de terceiros
* Determinar como definir funções e permissões
* Descrever abordagens de armazenamento em cache

Seção 3: Análise de negócios (38%)

* Mapear módulos padrão de AEM para diferentes problemas de negócios para o cliente
* Aplicar conceitos de gerenciamento de conteúdo para módulos de AEM
* Identificar os participantes típicos do projeto
* Aplicar conceitos processuais necessários para apoiar a colaboração de todas as partes envolvidas
* Determine como cumprir as principais metas de negócios, mantendo-se dentro do orçamento e/ou escopo
* Determine como as perguntas dos desenvolvedores devem ser respondidas em relação às metas comerciais
...
* Verifique a implementação correta dos recursos e localize e descreva os erros que ocorrem
...
* [Saiba mais sobre AEM recursos 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/user-guide/troubleshooting/learn.html?lang=en){target="_blank"}
...
* [Primeiras etapas para autores](https://experienceleague.adobe.com/docs/experience-manager-64/authoring/essentials/first-steps.html?lang=en){target="_blank"}
...
* [Gerenciamento de funções e permissões de usuários](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/users-and-roles/managing-user-roles-and-permissions.html?lang=en){target="_blank"}
...
* [Capítulo 2 - Infraestruturas](https://experienceleague.adobe.com/docs/experience-manager-learn/dispatcher-tutorial/chapter-2.html){target="_blank"}
* [Capítulo 3 - Tópicos avançados de armazenamento em cache](https://experienceleague.adobe.com/docs/experience-manager-learn/dispatcher-tutorial/chapter-3.html){target="_blank"}

**Seção 3: Análise de negócios**

* [Desenvolver sites da Web global no AEM](https://learning.adobe.com/catalog/adobe_experiencemanager/cours000000000087076.html){target="_blank"}
* [AEM conceitos principais](https://experienceleague.adobe.com/docs/experience-manager-65/developing/introduction/the-basics.html?lang=en){target="_blank"}
...
* [Abordagem de delivery e planejamento](https://experienceleague.adobe.com/docs/commerce-operations/implementation-playbook/planning/delivery.html){target="_blank"}
...
* [Gestão de contratos jurídicos](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/legal.html?lang=en){target="_blank"}
...
* [Lista de verificação - mais referência](https://experienceleague.adobe.com/docs/experience-manager-64/managing/managing-best-practices-checklist/best-practices-further-reference.html?lang=en){target="_blank"}
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E121 newtab=true"}[!BADGE Examidade]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E121 newtab=true"}
