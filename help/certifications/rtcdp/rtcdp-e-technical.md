...
>[!IMPORTANT]
>
>Atualmente, a certificação de Adobe [!DNL Experience Platform] Expert requer a aprovação em dois exames: **Adobe [!DNL Experience Platform] Technical Foundations (AD0-E600)** e **Adobe [!DNL Real-Time CDP] Technical Practitioner (AD7-E601)**. A partir de 15 de janeiro de 2024, um novo exame será iniciado, e esse será apenas o exame necessário para essa certificação.
...
[Ir para informações específicas do requisito 1](#req-1)

[Ir para as informações específicas do requisito 2](#req-2)
...
* Conhecimento básico do [!DNL Experience Platform] e sua navegação pela interface do usuário
* A capacidade de criar segmentos e públicos-alvo (lógica incluída nele)
...
* A compreensão da configuração do DULE durante a assimilação de dados, limitação de segmentos durante as ativações
* A compreensão dos requisitos de aceitação por canal
* A capacidade de projetar/entender os dados que precisam ser capturados e ativados após o uso das práticas recomendadas para a frequência e o volume dos dados do caso de uso
* A capacidade de compreender os dados necessários em diferentes canais
...
## Requisito #1: Informações para Adobe [!DNL Experience Platform] Technical Foundations (AD0-E600) {#req-1}

>[!IMPORTANT]
>
>A programação para o exame AD0-E600 foi colocada em espera. Este exame está sendo atualizado e será lançado em **15 de janeiro de 2024**. Após essa data, essa certificação exigirá apenas a aprovação em um exame, em vez dos dois exames atualmente necessários.
>
><br>
>
...
* Demonstrar como assimilar dados de origem por meio de lote e transmissão
* Descrever como monitorar as transferências de dados
...
* [Visão Geral de Esquema e XDM](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/schemas-and-experience-data-model.html){target="_blank"}

**Seção 2: assimilação de dados**

* [Assimilação de dados](https://experienceleague.adobe.com/docs/experience-platform/ingestion/home.html?lang=pt-BR){target="_blank"}

**Seção 3: Unificar perfis**
...
* [Criar segmentos com aprendizado de máquina usando o Perfil de cliente em tempo real](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-science-workspace/dsw-profile-segmentation.html){target="_blank"}
...
## Requisito #2: Informações para o profissional técnico do Adobe [!DNL Real-Time CDP] (AD7-E601) {#req-2}

>[!IMPORTANT]
>
>Este exame está sendo atualizado e será lançado em **15 de janeiro de 2024**. Após essa data, essa certificação exigirá apenas a aprovação em um exame, em vez dos dois exames atualmente necessários.
>
><br>
>
>**Se você não tiver feito nenhum dos exames necessários no momento,** recomendamos que aguarde o exame atualizado. Dessa forma, você pode fazer um exame em vez de dois.
>
><br>
>
...
* Aplique os conceitos necessários para validar se o Perfil tem os atributos e segmentos adequados
* Demonstrar uma compreensão de como validar uma estratégia de implantação com base em requisitos funcionais ou técnicos
* Analisar variáveis relevantes para implementar o Fluxo End to End (E2E) da RTCDP
...
* Demonstrar uma compreensão de como criar segmentos com base nas necessidades dos negócios
* Demonstrar uma compreensão de como determinar avaliações de segmento com base nos dados assimilados
...
[Responder ao questionário de preparação online](https://scorpion.caveon.com/launchpad/ad-q-e601-readiness-questionnaire-for-adobe-real-time-cdp-technical-practitioner-exam/ad-q-e601-readiness-questionnaire-for-adobe-real-time-cdp-technical-practitioner-exam){target="_blank"}
...
* [Medidas de proteção padrão para dados do Perfil do cliente em tempo real](https://experienceleague.adobe.com/docs/experience-platform/profile/guardrails.html?lang=pt-BR)
* [Habilitar Perfil de Cliente em Tempo Real](https://experienceleague.adobe.com/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/enable-profiles.html){target="_blank"}
...
* [Monitorar fluxos de dados para destinos na interface](https://experienceleague.adobe.com/docs/experience-platform/dataflows/ui/monitor-destinations.html){target="_blank"}
* [Visão geral sobre privacidade](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/privacy/privacy-overview.html){target="_blank"}
* [Governança de dados na CDP em tempo real](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/privacy/data-governance-overview.html){target="_blank"}
* [Aplicar estrutura de governança de dados](https://experienceleague.adobe.com/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/apply-data-governance-framework.html){target="_blank"}
* [Introdução à governança de dados](https://video.tv.adobe.com/v/333350/){target="_blank"}
* [Visão geral da governança de dados](https://video.tv.adobe.com/v/29708/){target="_blank"}
* [Demonstração de governança de dados](https://video.tv.adobe.com/v/36653/){target="_blank"}
...
* [Aplicar políticas de uso de dados](https://video.tv.adobe.com/v/33631/){target="_blank"}
...
* [Criar segmentos](https://experienceleague.adobe.com/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/build-segments.html){target="_blank"}
...
* [Criar segmentos com várias entradas](https://video.tv.adobe.com/v/32179/){target="_blank"}
* [Criar segmentos com dados B2B](https://video.tv.adobe.com/v/338252/){target="_blank"}
* [Demonstração da segmentação por transmissão](https://video.tv.adobe.com/v/36184){target="_blank"}
...
* [Visão geral do destino](https://experienceleague.adobe.com/docs/experience-platform/destinations/home.html?lang=pt-BR){target="_blank"}
...
* [Espaço de trabalho de destino](https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/destinations-workspace.html){target="_blank"}
* [Criar uma nova conexão de destino](https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/connect-destination.html){target="_blank"}
...
* [Integrar Correspondência de Cliente do Google](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/integrate-with-google-customer-match.html){target="_blank"}
...
* [Configurar o armazenamento na nuvem baseado em arquivo ou o destino do marketing por email](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html){target="_blank"}
...
* [Ativar dados para um aplicativo que não seja o Adobe](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=pt-BR){target="_blank"}
