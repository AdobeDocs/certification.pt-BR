...
# Jornada de certificação para Adobe [!DNL Real-Time Customer Data Platform] Especialista

Saiba como se tornar um Adobe certificado [!DNL Experience Platform] especialista em Real-time Customer Data Platform (RTCDP).
...
Faça um questionário de preparação para descobrir se você atende às qualificações mínimas.
...
* [[!DNL Real-Time Customer Data Platform] página inicial e painéis](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/intro/rtcdp-intro/home-page-dashboards.html?lang=en){target="_blank"}
...
* [Impor políticas de uso de dados](https://video.tv.adobe.com/v/33631/){target="_blank"}
