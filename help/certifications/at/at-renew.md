...
É importante observar que, se a certificação expirar antes de você concluir a renovação, será necessário refazer o exame de certificação, que NÃO é gratuito.
...
+++Adobe [!DNL Target] Exame de Renovação Profissional de Profissionais de Negócios

## Você deve ter as seguintes certificações **ativas** para renovar:

* Profissional de Profissional de Negócios [!DNL Adobe Target]
...
* Pontuação de aprovação: 31/24
* Tempo: 62 minutos
* Delivery: sob demanda/não monitorado
* Idiomas disponíveis: inglês
* Custo: GRATUITO
* Identificação do Exame: AD5-E838 - Adobe [!DNL Target] Profissional de Profissionais de Negócios

**Escopo e objetivos:**

Seção 1: Planejamento e estratégia 26%

* Identificar KPIs de negócios
* Dado um cenário de KPIs de negócios e análise de dados, identifique oportunidades para otimização
* Descreva como as variáveis afetam uma atividade
* Construir hipóteses de teste com base em um determinado cenário
* Identificação dos elementos da hipótese
* Descrever métricas de sucesso primárias e secundárias baseadas em KPI
* Dado um cenário, avalie os requisitos de público
* Descreva as fontes de relatórios de análise apropriadas (por exemplo, [!DNL Target] ou Adobe [!DNL Analytics])

Seção 2: Configuração, execução e gerenciamento de 45%

* Explicar o uso do Experience Composer baseado em formulário versus o Visual Experience Composer (VEC)
...
* Descrever procedimentos para gerenciar experiências em um compositor de experiências
* Descreva o fluxo de trabalho que se aplica à criação de [!DNL Target] atividades
* Dado um cenário, aplique procedimentos para criar uma atividade de teste A/B
* Dado um cenário, aplique procedimentos para criar uma atividade de XT
* Dado um cenário, aplique procedimentos para criar uma atividade MVT
* Identificar como a AP é usada para soluções
* Identificar quando usar a atividade de recomendação
* Descrever procedimentos para criar um Público-alvo em [!DNL Target]
...
* Descrever procedimentos para gerenciar Atividades e Públicos em [!DNL Target]

Seção 3: Análise e geração de relatórios 19%

* Descrever configurações para ajudar a definir os elementos que aparecem em um relatório
* Descreva a diferença nas configurações da Calculadora de Tamanho da Amostra do Adobe [!DNL Target] entre planejamento e validação
...
Seção 4: Controle de qualidade e solução de problemas 10%
...
* [Métricas de sucesso](https://experienceleague.adobe.com/docs/target/using/activities/success-metrics/success-metrics.html){target="_blank"}
* [Critério](https://experienceleague.adobe.com/docs/target/using/recommendations/criteria/algorithms.html){target="_blank"}
...
* [Práticas recomendadas para otimização com o Adobe Target](https://experienceleague.adobe.com/docs/target-learn/tutorials/administration/strategy/target-best-practices-for-optimization.html){target="_blank"}
...
* [Criar um público somente atividade](https://experienceleague.adobe.com/docs/target/using/audiences/creating-activity-only-audience.html){target="_blank"}
* [Adobe Analytics como origem de relatório do Adobe Target (A4T)](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/a4t.html){target="_blank"}
* [Configurar relatórios do A4T no Analysis Workspace para atividades de Alocação automática](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-allocate-activities.html){target="_blank"}
...
* [Criar públicos no Destino](https://experienceleague.adobe.com/docs/target/using/audiences/create-audiences/create-audience.html){target="_blank"}
* [Modificações](https://experienceleague.adobe.com/docs/target/using/experiences/vec/modifications/vec-code-editor.html){target="_blank"}
* [Experience Composer baseado em formulário](https://experienceleague.adobe.com/docs/target/using/experiences/form-experience-composer.html){target="_blank"}
* [Incluir a mesma experiência em páginas semelhantes](https://experienceleague.adobe.com/docs/target/using/experiences/vec/temtest.html){target="_blank"}
* [Metas e configurações](https://experienceleague.adobe.com/docs/target/using/activities/abtest/create/ab-goals-and-settings.html){target="_blank"}
* [Criar um teste A/B](https://experienceleague.adobe.com/docs/target/using/activities/abtest/create/test-create-ab.html){target="_blank"}
* [Direcionamento de experiência (XT)](https://experienceleague.adobe.com/docs/target/using/activities/experience-targeting/experience-target.html){target="_blank"}
* [Estimar o tráfego necessário para uma atividade de Teste Multivariado bem-sucedida](https://experienceleague.adobe.com/docs/target/using/activities/multivariate-test/create-mvt/traffic-estimator.html){target="_blank"}
* [Gerenciar exclusões](https://experienceleague.adobe.com/docs/target/using/activities/automated-personalization/managing-exclusions.html){target="_blank"}
...
* [Solucionar erros de atividade](https://experienceleague.adobe.com/docs/target-learn/tutorials/troubleshooting/4.2-troubleshoot-activity-errors.html){target="_blank"}
...
Verifique se você seguiu a etapa 1 acima e se fez logon com êxito no [Sistema de Gerenciamento de Credenciais do Adobe](https://www.certmetrics.com/adobe){target="_blank"} primeiro. Depois, para renovar sua certificação, clique no link Adobe [!DNL Target] Exame de Renovação Profissional de Profissional de Profissionais abaixo.

[!BADGE Realize o Adobe [!DNL Target] Exame de Renovação Profissional de Profissional de Negócios AD5-E838]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E838 newtab=true"}
...
* Especialista em Profissionais de Negócios [!DNL Adobe Target]
* [!DNL Adobe Target] Arquiteto Mestre

## Instruções para renovar sua certificação do [!DNL Adobe Target]
...
>[!NOTE]
>
>Se você tiver várias certificações de Especialista e Mestre do [!DNL Adobe Target], conclua os requisitos de renovação para apenas uma certificação, e o restante será renovado automaticamente.
...
| [[!DNL Adobe Target] Inovações no curso do Personalization](https://business.adobe.com/summit/2021/sessions/adobe-target-innovations-in-personalization-s901.html){target="_blank"} | [ADR-EA402](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA402){target="_blank"} |
| [Implementação de aplicativos móveis e curso do Personalization](https://experienceleague.adobe.com/?recommended=Target-D-1-2020.1.mobile){target="_blank"} | [ADR-EA403](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA403){target="_blank"} |
| [Inicialização guiada de dispositivos móveis e IoT para o curso de desenvolvedores](https://experienceleague.adobe.com/?recommended=Target-D-1-2019.1.web){target="_blank"} | [ADR-EA404](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA404){target="_blank"} |
| [Inicialização guiada de site para o curso de desenvolvedores](https://experienceleague.adobe.com/?recommended=Target-D-1-2019.1.web){target="_blank"} | [ADR-EA405](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA405){target="_blank"} |
