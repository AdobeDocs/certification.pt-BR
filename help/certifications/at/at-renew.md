...
+++Adobe [!DNL Target] Exame de Renovação Profissional de Profissional de Negócios

## Você deve ter o seguinte **ativo** certificações a renovar:

* [!DNL Adobe Target] Profissional de Profissional de Negócios
...
* Custo: GRATUITO
* ID do exame: AD5-E838 - Adobe [!DNL Target] Profissional de Profissional de Negócios
...
* Descreva o workflow que se aplica à criação de [!DNL Target] Atividades
...
* Descrever procedimentos para criar um público-alvo no [!DNL Target]
...
* Descrever procedimentos para gerenciar Atividades e públicos-alvo na [!DNL Target]
...
* Descrever a diferença no Adobe [!DNL Target] Configurações da Calculadora de Tamanho de Amostra entre o planejamento e a validação
...
* [Critérios](https://experienceleague.adobe.com/docs/target/using/recommendations/criteria/algorithms.html){target="_blank"}
...
[!BADGE Pegue o Adobe [!DNL Target] Exame de Renovação Profissional de Profissional de Negócios AD5-E838]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=AD5-E838 newtab=true"}
...
>[!NOTE]
>
>Se você tiver vários [!DNL Adobe Target] Certificações de especialista e mestre, atenda aos requisitos de renovação para apenas uma certificação e o restante será renovado automaticamente.
