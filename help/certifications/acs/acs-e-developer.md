...
description: Saiba como se tornar um Adobe de especialista certificado da Adobe Developer [!DNL Campaign Standard].
...
# Jornada de certificação para Adobe [!DNL Campaign Standard] Especialista em desenvolvedores
...
* Pelo menos dois anos de [!DNL Campaign] experiência de software
* Pelo menos dois anos de experiência relevante em campanhas de marketing digital multicanal e desenvolvimento da Web (por exemplo, REST API)
* A capacidade de executar tarefas no Adobe Campaign, incluindo desenvolvimento de modelo, fluxos de trabalho técnicos, desenvolvimento de esquema e integrações, e pode monitorar a instância usando o painel de controle
* Experiência trabalhando em um ambiente de delivery de canal (email, mala direta, celular e social)
* Familiaridade com táticas de campanha de marketing, como multitoque, ciclo de vida e reativação
* Noções básicas sobre métricas de marketing, como ROI, taxas de click-through e conversão.
* Experiência de administração de uma plataforma de automação de marketing
* Conhecimento básico de CSS, HTML e JavaScript, emails
* Conhecimento básico da base de dados relacional e da modelagem de dados
* Uma compreensão dos workflows técnicos e os configurou
* Experiência de extensão de uma tabela ou esquema de recipient e gerenciamento de dados
* Regras de tipologia, workflows, delivery e templates do Campaign criados
* Funções e direitos configurados
* Experiência com o console de administração e integração com outros aplicativos Adobe
* Consciência do Adobe I/O e Adobe I/O Runtime
...
Complete o [questionário de disponibilidade online](https://scorpion.caveon.com/launchpad/ad-q-e306-readiness-questionnaire-for-adobe-campaign-standard-developer-expert-exam){target="_blank"} para ver se a sua experiência atual corresponde à qualificação mínima de candidato recomendada.

**Objetivos e âmbito do exame**

Seção 1: Modelagem e gerenciamento de dados (26%)

* Dado um cenário, transforme um requisito de cliente em um recurso personalizado
* Determine como configurar definições de tela e filtro
* Em um cenário, determine a estratégia correta para definir chaves, índices e links
...
Seção 2: Gerenciamento de campanhas (50%)

* Solução de problemas de erros de workflow
* Determine a abordagem correta para criar campanhas
* Determine a abordagem correta para trabalhar com públicos-alvo e perfis
...
* Determinar a abordagem correta para trabalhar com serviços e assinaturas
* Em um cenário, valide os mecanismos de delivery
* Determine a abordagem correta para criar emails usando o criador
...
* Determine a abordagem correta para configurar opções
* Determine a abordagem correta para criar marcas
* Determine a abordagem correta para desenvolver configurações de canal
...
* O PSI oferece opções de teste de centro e teste japonês (quando disponível)
* A experiência oferece uma opção online remota

Para agendar, reprogramar ou cancelar seu exame, basta clicar no fornecedor escolhido e seguir as instruções fornecidas na tela. É tão simples assim!

### Número do exame: AD0-E306

[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E306 newtab=true"}[!BADGE Examidade]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E306 newtab=true"}
