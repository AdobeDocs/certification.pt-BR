...
* Verifique novamente o fuso horário no perfil do Exame, acessando o sistema de Gerenciamento de credenciais do Adobe, clicando em Agendar/Modificar meu Compromisso de Exame, selecionando o exame e acessando o perfil do Exame.
...
* Prepare seu espaço na mesa. Remova todos os monitores, equipamentos eletrônicos, livros, notebooks, papéis, etc. adicionais. do desktop.
...
* Após a conclusão do exame, você receberá uma aprovação provisória/reprovação; no entanto, sua pontuação final pode levar até 72 horas. Depois que o exame for revisado e finalizado, você encontrará o cartão de pontuação no Adobe Credential Management na guia &quot;History&quot;.
* Se você não passar em um exame de certificação de Adobe na primeira tentativa, aguarde pelo menos 24 horas antes de refazer o exame. Uma nota reprovada na segunda ou em qualquer tentativa subsequente requer um período de espera de 14 dias antes de refazer o exame. Cada tentativa incorre em uma taxa de exame separada.
...
>[!NOTE]
>
>O Programa de certificação de experiência digital Adobe está simplificando o processo de renovação da certificação para tornar sua experiência mais conveniente. Enquanto este novo processo está sendo implementado, **renovações estão temporariamente suspensas.**
>
...
>
>**Visite o novo [Portal de Certificação do Adobe](https://certification.adobe.com/certifications/learn-more?tab=learnmore8){target="_blank"} para obter as informações mais atualizadas.**
